...
if os.path.exists("Results-sq3/plot-%d-%f-%d-%d.png"%(n,r,T,seed))==False:
    rd.seed(seed)
    # data
    R = rd.normal(0,1,n)
    ...
    for ite in range(ITE):
        ...
        plt.savefig("Results-sq3/plot-%d-%f-%d-%d.png"%(n,r,T,seed), bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 