...
if os.path.isdir("PL/sq-objW")==False: os.makedirs("PL/sq-objW", exist_ok=True)
if os.path.isdir("PL/sq-rank1")==False: os.makedirs("PL/sq-rank1", exist_ok=True)
if os.path.isdir("PL/sq-rank3")==False: os.makedirs("PL/sq-rank3", exist_ok=True)
...
for r in [.1,.3,.5,.7,.9]:
    ...
    plt.savefig("./PL/sq-objW/%f.png"%r, bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
    ...
    ax1.set_ylabel(r'training (red, solid, diamond)'); ax2.set_ylabel(r'test (blue, dashed, circle)')
    ax1.set_xlim(0,21); ax2.set_xlim(0,21); ax1.grid(True); ax2.grid(True)
    plt.savefig("./PL/sq-rank1/%f.png"%r, bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
    ...
    ax1.set_ylabel(r'training (red, solid, diamond)'); ax2.set_ylabel(r'test (blue, dashed, circle)')
    ax1.set_xlim(0,21); ax2.set_xlim(0,21); ax1.grid(True); ax2.grid(True)
    plt.savefig("./PL/sq-rank3/%f.png"%r, bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 


if os.path.isdir("PL/nll-objW")==False: os.makedirs("PL/nll-objW", exist_ok=True)
if os.path.isdir("PL/nll-rank1")==False: os.makedirs("PL/nll-rank1", exist_ok=True)
if os.path.isdir("PL/nll-rank3")==False: os.makedirs("PL/nll-rank3", exist_ok=True)
...
for r in [.1,.3,.5,.7,.9]:
    ...
    ax1.set_ylabel(r'training (red, solid, diamond)'); ax2.set_ylabel(r'test (blue, dashed, circle)')
    ax1.set_xlim(0,21); ax2.set_xlim(0,21); ax1.grid(True); ax2.grid(True)
    plt.savefig("./PL/nll-objW/%f.png"%r, bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
    test = stats.mannwhitneyu(res[:,np.argmin(tes1)//2,16*(np.argmin(tes1)%2)+1], res[:,0,1], alternative='less')
    ...
    ax1.set_ylabel(r'training (red, solid, diamond)'); ax2.set_ylabel(r'test (blue, dashed, circle)')
    ax1.set_xlim(0,21); ax2.set_xlim(0,21); ax1.grid(True); ax2.grid(True)
    plt.savefig("./PL/nll-rank1/%f.png"%r, bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
    test = stats.mannwhitneyu(res[:,np.argmax(tes1)//2,16*(np.argmax(tes1)%2)+5], res[:,0,5], alternative='greater')
    ...
    ax1.set_ylabel(r'training (red, solid, diamond)'); ax2.set_ylabel(r'test (blue, dashed, circle)')
    ax1.set_xlim(0,21); ax2.set_xlim(0,21); ax1.grid(True); ax2.grid(True)
    plt.savefig("./PL/nll-rank3/%f.png"%r, bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
