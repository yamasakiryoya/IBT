...
# if os.path.isdir("Results-PR/%d-%f-%d"%(n,r,T))==False: os.makedirs("Results-PR/%d-%f-%d"%(n,r,T), exist_ok=True)
if os.path.isdir("Results-sq/%d-%f-%d"%(n,r,T))==False: os.makedirs("Results-sq/%d-%f-%d"%(n,r,T), exist_ok=True)
if os.path.exists("Results-sq/%d-%f-%d/error-%d-%f-%d-%d.csv"%(n,r,T,n,r,T,seed))==False:
    rd.seed(seed)
    # data
    ...
    # if T==1: np.savetxt("Results-PR/%d-%f-%d/error-%d-%f-%d-%d.csv"%(n,r,T,n,r,T,seed), err, delimiter=",")
    np.savetxt("Results-sq/%d-%f-%d/error-%d-%f-%d-%d.csv"%(n,r,T,n,r,T,seed), err, delimiter=",")
