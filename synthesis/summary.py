...
if os.path.isdir("Plots/nll-objW")==False: os.makedirs("Plots/nll-objW", exist_ok=True)
if os.path.isdir("Plots/nll-objY")==False: os.makedirs("Plots/nll-objY", exist_ok=True)
if os.path.isdir("Plots/nll-rank1")==False: os.makedirs("Plots/nll-rank1", exist_ok=True)
if os.path.isdir("Plots/nll-rank2")==False: os.makedirs("Plots/nll-rank2", exist_ok=True)
if os.path.isdir("Plots/nll-rank3")==False: os.makedirs("Plots/nll-rank3", exist_ok=True)
if os.path.isdir("Plots/nll-rank4")==False: os.makedirs("Plots/nll-rank4", exist_ok=True)
if os.path.isdir("Plots/nll-rank5")==False: os.makedirs("Plots/nll-rank5", exist_ok=True)
if os.path.isdir("Plots/nll-rank6")==False: os.makedirs("Plots/nll-rank6", exist_ok=True)
    ...
    for r in [.1,.3,.5,.7,.9]:
        for T in [1,5,25]:
            ...
            for seed in range(100):
                res[seed] = np.loadtxt("Results-nll/%d-%f-%d/error-%d-%f-%d-%d.csv"%(n,r,T,n,r,T,seed), delimiter=",")#np.nan_to_num(, posinf=10.**20)
                for k in range(10):
            ...
            plt.savefig("./Plots/nll-objW/%d-%f-%d.png"%(n,r,T), bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
            ...
            ax.set_ylabel(r'WPP error')
            ax.set_xlim(0,21); ax.grid(True)
            plt.savefig("./Plots/nll-objY/%d-%f-%d.png"%(n,r,T), bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
            ...
            ax.set_xlim(0,21); ax.grid(True)
            plt.savefig("./Plots/nll-rank1/%d-%f-%d.png"%(n,r,T), bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
            ...
            ax.set_xlim(0,21); ax.grid(True)
            plt.savefig("./Plots/nll-rank2/%d-%f-%d.png"%(n,r,T), bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
            ...
            ax.set_xlim(0,21); ax.grid(True)
            plt.savefig("./Plots/nll-rank3/%d-%f-%d.png"%(n,r,T), bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
            ...
            ax.set_ylabel(r"Kendall's Tau")
            ax.set_xlim(0,21); ax.grid(True)
            plt.savefig("./Plots/nll-rank4/%d-%f-%d.png"%(n,r,T), bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
            ...
            ax.set_ylabel(r"Spearman's Rho")
            ax.set_xlim(0,21); ax.grid(True)
            plt.savefig("./Plots/nll-rank5/%d-%f-%d.png"%(n,r,T), bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
            ...
            ax.set_ylabel(r'Tie criterion')
            ax.set_xlim(0,21); ax.grid(True)
            plt.savefig("./Plots/nll-rank6/%d-%f-%d.png"%(n,r,T), bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 



if os.path.isdir("Plots/sq-objW")==False: os.makedirs("Plots/sq-objW", exist_ok=True)
if os.path.isdir("Plots/sq-objY")==False: os.makedirs("Plots/sq-objY", exist_ok=True)
if os.path.isdir("Plots/sq-rank1")==False: os.makedirs("Plots/sq-rank1", exist_ok=True)
if os.path.isdir("Plots/sq-rank2")==False: os.makedirs("Plots/sq-rank2", exist_ok=True)
if os.path.isdir("Plots/sq-rank3")==False: os.makedirs("Plots/sq-rank3", exist_ok=True)
if os.path.isdir("Plots/sq-rank4")==False: os.makedirs("Plots/sq-rank4", exist_ok=True)
if os.path.isdir("Plots/sq-rank5")==False: os.makedirs("Plots/sq-rank5", exist_ok=True)
if os.path.isdir("Plots/sq-rank6")==False: os.makedirs("Plots/sq-rank6", exist_ok=True)
...
for n in [25,50,100,200,400]:
    for r in [.1,.3,.5,.7,.9]:
        for T in [1,5,25]:
            res = np.zeros((100,10,32))
            for seed in range(100):
                res[seed] = np.loadtxt("Results-sq/%d-%f-%d/error-%d-%f-%d-%d.csv"%(n,r,T,n,r,T,seed), delimiter=",")#np.nan_to_num(, posinf=10.**20)
                for k in range(10):
                    if np.all(res[seed,k,:] == 0):
                        res[seed,k,:16] = res[seed,k-1,16:]
                        res[seed,k,16:] = res[seed,k-1,16:]
            ...
            ax.set_ylabel(r'WPP error')
            ax.set_xlim(0,21); ax.grid(True)
            plt.savefig("./Plots/sq-objW/%d-%f-%d.png"%(n,r,T), bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
            ...
            ax.set_ylabel(r'WPP error')
            ax.set_xlim(0,21); ax.grid(True)
            plt.savefig("./Plots/sq-objY/%d-%f-%d.png"%(n,r,T), bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
            ...
            ax.set_ylabel(r"Kendall's Tau")
            ax.set_xlim(0,21); ax.grid(True)
            plt.savefig("./Plots/sq-rank1/%d-%f-%d.png"%(n,r,T), bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
            ...
            ax.set_ylabel(r"Spearman's Rho")
            ax.set_xlim(0,21); ax.grid(True)
            plt.savefig("./Plots/sq-rank2/%d-%f-%d.png"%(n,r,T), bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
            ...
            ax.set_ylabel(r'Tie criterion')
            ax.set_xlim(0,21); ax.grid(True)
            plt.savefig("./Plots/sq-rank3/%d-%f-%d.png"%(n,r,T), bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
            ...
            ax.set_ylabel(r"Kendall's Tau")
            ax.set_xlim(0,21); ax.grid(True)
            plt.savefig("./Plots/sq-rank4/%d-%f-%d.png"%(n,r,T), bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
            ...
            ax.set_ylabel(r"Spearman's Rho")
            ax.set_xlim(0,21); ax.grid(True)
            plt.savefig("./Plots/sq-rank5/%d-%f-%d.png"%(n,r,T), bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
            ...
            ax.set_ylabel(r'Tie criterion')
            ax.set_xlim(0,21); ax.grid(True)
            plt.savefig("./Plots/sq-rank6/%d-%f-%d.png"%(n,r,T), bbox_inches="tight", pad_inches=.02, facecolor=fig.get_facecolor(), dpi=100, edgecolor='none', metadata={'Software': None}, pil_kwargs={'optimize': True}); plt.close()#,format='webp', 
